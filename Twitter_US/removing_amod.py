...
with open("D:/data/json_data/parsed_data/tweet_us_parsed_neu.json") as json_file:
...
with open("D:/data/json_data/removed_data/Twitter_US_Airline/removed_amod_neu.json", 'w') as outfile:
